...
function abcd(a){ // here a is a parameter
console.log(a);
}
...
// Arrays = to store more than one value
 ...
 arr.splice(2,1) // to remove a value from any random place from array here 2=index, 1=total no. of value to be removed.
...
var a={
  ...
  kaamkaro: function(){} // method, because it is a function inside an object
}
a.name // to access value of object
